...
@Component({
  selector: 'app-tab-letter',
  templateUrl: './tab-letter.component.html',
  styleUrls: ['./tab-letter.component.css']
})
export class TabLetterComponent implements OnInit, OnDestroy {
  ...
  refreshList(){
    try
    {
      this.characters = this.tabService.charactersLetter;
    }
    catch(err)
    {
      console.log(err);
